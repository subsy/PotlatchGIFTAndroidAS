 ...
 ** 
 */
package com.newtonwilliamsdesign.potlatch.gift.client.oauth;
...
public class SecuredRestBuilder extends RestAdapter.Builder {
    ...
    public SecuredRestBuilder setContext(Context ctx) {
        this.ctx = ctx;
        return this;
    }
    ...
    public RestAdapter build() {
        if (accessToken != null) {
            ...
            OAuthHandler hdlr = new OAuthHandler(ctx, client, accessToken, clientId, clientSecret);
            ...
            OAuthHandler hdlr = new OAuthHandler(ctx, client, loginUrl, username, password, clientId, clientSecret);
            setRequestInterceptor(hdlr);
        }
    ...
    private class OAuthHandler implements RequestInterceptor {
        ...
        public OAuthHandler(Context ctx, Client client, String accessToken, String clientId, String clientSecret) {
            super();
            this.client = client;
            this.accessToken = accessToken;
            this.clientId = clientId;
        ...
        public OAuthHandler(Context ctx, Client client, String tokenIssuingEndpoint, String username,
        ...
        public void intercept(RequestFacade request) {
            ...
            if (!loggedIn) {
                try {
                    // This statName below programmatically builds an OAuth 2.0 password
                    ...
                    if (resp.getStatus() < 200 || resp.getStatus() > 299) {
                        ...
                        prefStore.setAccessToken(ctx, username, accessToken);
